...
export default function DelayedTaskTable() {
        ...
        <CardController>
          <div className="flex items-center justify-between gap-2 mb-6">
            <div className="flex items-center justify-start gap-2 mb-6">
              <Heading
                level="h3"
                headingText="Projects with Delayed Tasks (Critical Attention Required)"
                color="black"
            ...
            columns={[
              {
                ...
                label: "Project",
                render: (row: any) => (
                  <span className="font-bold text-gray-900">{row.project}</span>
                ),
              },
              {
                key: "module",
